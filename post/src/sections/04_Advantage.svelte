...
<Section eyebrow="4 · Advantage" title="Group-relative, no critic" id="advantage">
  <Prose>
    <p>
      The advantage answers a simple question: <em>how did this trajectory perform compared to its peers?</em> I find out by standardizing the group's raw rewards:
    </p>
